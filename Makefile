...
sync:
	aws --region us-east-1 --profile reviewtheinterview s3 sync --exclude "pending-reviews/pending-reviews.json" --exclude "reviews/reviews.json" --exclude "js/review-the-interview.js" --exclude "css/review-the-interview.css" --exclude "css/review-the-interview.css.map" --exclude "index.html" --acl public-read $(OUTPUTDIR)/ s3://testing.reviewtheinterview.com
